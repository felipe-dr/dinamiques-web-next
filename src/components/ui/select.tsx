...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex w-full items-center justify-between rounded-sm lg:rounded-md border border-base-14 bg-base-15 px-4 py-3 lg:px-5 lg:py-4 text-sm lg:text-lg ring-offset-primary-7 placeholder:text-base-9 focus:outline-none focus:ring-2 focus:ring-base-14 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-base-1', className)}
    {...props}
  />
));
...
export {
  ...
  SelectScrollDownButton as SelectScrollDownButtonComponent,
  SelectScrollUpButton as SelectScrollUpButtonComponent,
  SelectSeparator as SelectSeparatorComponent,
