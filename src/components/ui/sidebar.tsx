...
const SidebarTrigger = React.forwardRef<
  React.ElementRef<typeof ButtonComponent>,
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <ButtonComponent
      className={cn(
        buttonVariants({ variant: 'ghost', size: 'icon', color: 'gray' }),
        className,
      )}
      ref={ref}
      ...
      {...props}
    >
      <ViewColumnsIcon className="text-base-white" />
...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<'button'> & {
    asChild?: boolean;
    isActive?: boolean;
    tooltip?: string | React.ComponentProps<typeof TooltipContentComponent>;
...
>(
  (
    ...
    return (
      <TooltipComponent>
        <TooltipTriggerComponent asChild>{button}</TooltipTriggerComponent>
        <TooltipContentComponent
          side="right"
          align="center"
